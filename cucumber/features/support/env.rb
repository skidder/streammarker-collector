...
ENV['FABRIC_DAO_DYNAMO_TITLE_TABLE'] = 'sampleTitleTable'
ENV['FABRIC_DAO_DYNAMO_ASSET_TABLE'] = 'sampleAssetTable'
ENV['FABRIC_DAO_DYNAMO_CDN_CONFIG_TABLE'] = 'sampleCDNConfigTable'
ENV['FABRIC_DAO_DYNAMO_ENDPOINT'] = "http://#{FAKEDYNAMO_HOST}:#{FAKEDYNAMO_PORT}"
ENV['FABRIC_DAO_DYNAMODB_DISABLE_SSL'] = 'TRUE'
ENV['FABRIC_AUTH_TOKEN'] = '1e98db83-22b2-4bf9-b637-abe57c62610e'
